...
urlpatterns = [
    ...
    path('password-reset/done/', auth_views.PasswordResetDoneView.as_view(template_name="index.html", extra_context={"alert": "If your email is associated with a registered account, you will will receive an email with instructions on how to change your password."}), name='password_reset_done'),
]
