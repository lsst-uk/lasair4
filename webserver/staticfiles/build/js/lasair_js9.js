document.addEventListener('DOMContentLoaded', function() {
    ...
    allFits.forEach(function(fits) {
        ...
        let uuid = uuidv4();
        newItem.innerHTML = `<div class="JS9Menubar d-none" id="${uuid}Menubar" data-width="100%"></div>
<div class="JS9" data-width="100%" style="height:0; padding-bottom:100%" id="${uuid}"></div>`;
