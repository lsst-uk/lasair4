...
def conesearch_impl(cone):
    ...
    **Usage:**
    ...
    ```python
    from lasair.search import conesearch_impl
...
def readcone(cone):
    ...
    **Usage:**
    ...
    ```python
    from lasair.search import readcone
...
def distance(ra1, de1, ra2, de2):
    ...
    **Usage:**
    ...
    ```python
    from lasair.search import distance
...
def sexra(tok):
    ...
    **Usage:**
    ...
    ```python
    from lasair.search import sexra
    raDeg = sexra(raSex)
    ```           
    """
...
def sexde(tok):
    ...
    **Usage:**
    ...
    ```python
    from lasair.search import decra
